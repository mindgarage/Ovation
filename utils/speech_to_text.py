...
class SpeechRecognizer:
    ...
    def google_cloud_engine(self, audio):
        ...
        try:
            print("Google Cloud Speech thinks you said ",
                  self.recognizer.recognize_google_cloud(audio, credentials_json=GOOGLE_CLOUD_SPEECH_CREDENTIALS))
        except sr.UnknownValueError:
    ...
    def wit_engine(self, audio):
        ...
        try:
            print("Wit.ai thinks you said ",
                  self.recognizer.recognize_wit(audio, key=WIT_AI_KEY))
        except sr.UnknownValueError:
    ...
    def ms_bing_engine(self, audio):
        ...
        try:
            print("Microsoft Bing Voice Recognition thinks you said ",
                  self.recognizer.recognize_bing(audio, key=BING_KEY))
        except sr.UnknownValueError:
    ...
    def houndify_engine(self, audio):
        ...
        try:
            print("Houndify thinks you said ",
                  self.recognizer.recognize_houndify(audio, client_id=HOUNDIFY_CLIENT_ID, client_key=HOUNDIFY_CLIENT_KEY))
        except sr.UnknownValueError:
    ...
    def watson_engine(self, audio):
        ...
        try:
            print("IBM Speech to Text thinks you said ",
                  self.recognizer.recognize_ibm(audio, username=IBM_USERNAME, password=IBM_PASSWORD))
        except sr.UnknownValueError:
